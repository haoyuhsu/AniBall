...
namespace TrailsFX
{
	...
	public class TrailEffectEditor : Editor
	{
		...
		SerializedProperty drawBehind, cullMode, cam, lookTarget, lookToCamera, ground;
		...
		SerializedProperty useLastAnimationState, maxBatches, animationStates;
		...
		public override void OnInspectorGUI ()
		{
			...
			if (t != null && t.GetComponentsInChildren<Renderer> ().Length > 1) {
		...
		void CreateProfile ()
		{
			...
			TrailEffectProfile newProfile = ScriptableObject.CreateInstance<TrailEffectProfile> ();
