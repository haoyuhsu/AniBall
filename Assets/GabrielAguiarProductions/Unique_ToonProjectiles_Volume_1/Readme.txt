Unique Toon Projectiles Volume 1 - Readme


This package contains:

- 50 Projectiles Prefabs (19 Unique with Color variations);
- 48 Hits/Impacts Prefabs (18 Unique with Color variations;
- 46 Muzzles Prefabs (18 Unique with Color variations);
- 2D Demo;
- PC Demo;
- Mobile Demo;
- 8K and 2K Textures;
...
NOTES:
All scripts are used for DEMONSTRATION porpuses of the Projectiles. I recommend everyone to create their own code for their own projects.



Thank you for purchasing the Unique Toon Projectiles Volume 1 package.
Unique Toon Projectiles Volume 01 is created by Gabriel Aguiar
